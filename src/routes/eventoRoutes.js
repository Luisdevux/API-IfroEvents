...
import upload, { uploadCondicional } from "../config/multerConfig.js";
...
router
    .post("/eventos/", AuthMiddleware, uploadCondicional([{ name: 'midiaVideo', maxCount: 1 }, { name: 'midiaCapa', maxCount: 1 }, { name: 'midiaCarrossel', maxCount: 10 }]), 
    asyncWrapper(eventoController.cadastrar.bind(eventoController)))
