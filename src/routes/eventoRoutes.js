...
import upload, { uploadMultiplo, uploadCondicional } from "../config/multerConfig.js";
...
router
    // Rota otimizada - middleware condicional integrado
    .post("/eventos/", uploadCondicional([{ name: 'midiaVideo', maxCount: 1 }, { name: 'midiaCapa', maxCount: 1 }, { name: 'midiaCarrossel', maxCount: 10 }]), 
    AuthMiddleware, asyncWrapper(eventoController.cadastrar.bind(eventoController)))
    ...
    .patch("/eventos/:id/finalizar-cadastro", AuthMiddleware, asyncWrapper(eventoController.finalizarCadastro.bind(eventoController)))
