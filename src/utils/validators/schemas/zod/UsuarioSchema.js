...
const UsuarioSchema = z.object({
  matricula: z.string()
  .regex(/^\d+$/, 'Matrícula inválida!')
  .max(13, 'Matrícula deve ter no máximo 13 caracteres.'),
  ...
  .regex(
    senhaRegex,
    'A senha deve conter pelo menos 1 letra maiúscula, 1 letra minúscula, 1 número, 1 caractere especial e no mínimo 8 caracteres.'
  )
});
